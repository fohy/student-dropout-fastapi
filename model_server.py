...
FEATURE_COLUMNS = [
    ...
    'fromEkaterinburg', 'fromSverdlovskRegion', 'Human Development Index', 'Полных лет на момент поступления',
    'Особая квота', 'Отдельная квота', 'Целевая квота',
    'всероссийская олимпиада школьников (ВОШ)',
    'олимпиада из перечня, утвержденного МОН РФ (ОШ)', 'Заочная', 'Очно-заочная', 'Специалист',
